...
public class PostresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        promoList.add(new Promo1(R.drawable.postre1, "Pay de Nuez!!", "Un clasico de sabor y textura", "Precio $6500"));
        promoList.add(new Promo1(R.drawable.postre2, "Pastel de tres leches  !!", "Una absoluta tentacion!!", "Precio $5000"));
        promoList.add(new Promo1(R.drawable.postre3, "Pastel Ferrero !! ", "Una maravilla para compartir", "Precio $4990"));
        promoList.add(new Promo1(R.drawable.postre4, "Brownie de Chocolate", "Delicioso !!!", "Precio $7990"));
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PostresActivity.this, CategorizeActivity.class);
