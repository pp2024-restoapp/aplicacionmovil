...
public class PastasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        promoList.add(new Promo1(R.drawable.pasta1, "Espaguetis a la Boloñesa!!", "Un clasico de sabor y textura", "Precio $6500"));
        promoList.add(new Promo1(R.drawable.pasta2, "Ravioles rellenos 4 quesos  !!", "Una absoluta tentacion!!", "Precio $5000"));
        promoList.add(new Promo1(R.drawable.pasta3, "Lasaña de Carne  !! ", "Un clasico de la cocina", "Precio $4990"));
        promoList.add(new Promo1(R.drawable.pasta4, "Carbonara", "Una joya de Roma!!!", "Precio $6990"));
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PastasActivity.this, CategorizeActivity.class);
