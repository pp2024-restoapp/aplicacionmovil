...
public class PizzasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        promoList.add(new Promo1(R.drawable.pizzas1, "Pizza de hongos y Cebollina!!", "Un clasico Italiano", "Precio $10500"));
        promoList.add(new Promo1(R.drawable.pizzas2, "Pizza a la Napolitana  !!", "Un clasico Argentino!!", "Precio $9000"));
        promoList.add(new Promo1(R.drawable.pizzas3, "Pizza Hawaiana !! ", "Desde la decada 1960", "Precio $8990"));
        promoList.add(new Promo1(R.drawable.pizzas4, "Pizza Mexicana", "Un clasico de Mexico !!!", "Precio $10990"));
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PizzasActivity.this, CategorizeActivity.class);
