...
public class LomosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lomos);
        ...
        promoList.add(new Promo1(R.drawable.lomo1, "Lomo Cordobes!!", "Probalo un amor !!", "Precio $6500"));
        promoList.add(new Promo1(R.drawable.lomo2, "Lomo Vegetariano !!", "Cuida tu figura !!", "Precio $5000"));
        promoList.add(new Promo1(R.drawable.lomo3, "Lomo Mexicano  !! ", "Un clasico de Mexico", "Precio $4990"));
        promoList.add(new Promo1(R.drawable.lomo4, "Lomo al Plato", "Un clasico sin harinas !!!", "Precio $6990"));
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LomosActivity.this, CategorizeActivity.class);
