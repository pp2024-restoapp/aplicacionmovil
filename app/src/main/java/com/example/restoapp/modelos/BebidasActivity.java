...
public class BebidasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        promoList.add(new Promo1(R.drawable.bebida1, "Aperol Spritz !!", "Tendencia del momento", "Precio $5500"));
        promoList.add(new Promo1(R.drawable.bebida2, "Piña Colada y Ron!!", "El coctel mas clasico !!", "Precio $5000"));
        promoList.add(new Promo1(R.drawable.bebida4, "Jugos Naturales!! ", "Gran variedad de Frutas", "Precio $1990"));
        promoList.add(new Promo1(R.drawable.bebida3, "Tiguer Jack", "Con 4 ingredientes !!!", "Precio $3990"));
        ...
        btnAtras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BebidasActivity.this, CategorizeActivity.class);
